    ...
    return this.each(function () {
      ...
      function bindMouseScrollXHandler() {
        ...
        var mouseMoveHandler = function (ev) {
          updateScrollLeft(currentLeft, ev.pageX - currentPageX);
          updateGeometry();
          //ev.stopPropagation();
          //ev.preventDefault();
        };
      ...
      function bindSelectionHandler() {
        ...
        function startScrolling() {
          var float_ids = ['personnel-details-pane', 'equipment-details-pane'];

          if(float_ids.indexOf($this.prop('id')) !== -1) {
            return false;
          }
